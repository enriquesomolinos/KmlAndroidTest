...
public class NavigationSaxHandler extends DefaultHandler
{
	...
	private StringBuffer coordinatebuffer;
	        ...
	        String qName, Attributes atts) throws SAXException
	{
		...
		else if (localName.equals("coordinates"))
		{
			...
			coordinatebuffer = new StringBuffer();
	        ...
	        throws SAXException
	{
		...
		else if (localName.equals("coordinates"))
		{
			...
			navigationDataSet.getCurrentPlacemark().setCoordinates(coordinatebuffer.toString().replace("\n"," "));
		}
	}
	...
	public void characters(char ch[], int start, int length)
	{
		...
		{
			coordinatebuffer.append(new String(ch, start, length));
